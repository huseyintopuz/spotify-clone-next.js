          ...
          <div className='flex space-x-4'>
            <div className='space-x-4'>
              ...
              <button type="button" className={disabled ? 'disabledButton' : 'enabledButton'}>
                <RightCircleFilled className='text-3xl' style={{ color: 'rgb(31 41 55)' }} />
              </button>
            </div>
            <Button type="primary" shape="round" style={{ background: 'black', padding: '4px 32px', border: 'none', fontWeight: 'bold' }}
              className='library'
            >
              Playlists
            </Button>
